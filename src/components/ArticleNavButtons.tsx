...
const BTN_CLASS =
  'bg-surface-container-lowest border border-outline-variant shadow-sm rounded-xl w-12 h-12 flex items-center justify-center hover:bg-surface-container transition-colors cursor-pointer text-on-surface-variant'
    ...
    <div className="fixed right-4 bottom-4 z-30 flex flex-col gap-2 items-center">
      {hasToc && (
        <button className={BTN_CLASS} onClick={scrollToToc} aria-label="목차로 이동">
          <svg width="21" height="21" viewBox="0 0 14 14" fill="none" aria-hidden="true">
